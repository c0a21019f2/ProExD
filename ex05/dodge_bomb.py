...
class Bird:
    ...
    def __init__(self, img_path, ratio, xy):
        ...
        self.sfc = pg.transform.rotozoom(tori_sfc, 0, ratio)
        self.rct = tori_sfc.get_rect()
    ...
    def update(self, scr:Screen):
        ...
        for key, delta in Bird.key_delta.items():
            ...
            if check_bound(self.rct, selfrct) != (+1, +1):     
                self.rct.centerx -= delta[0]
                self.rct.centery -= delta[1]
...
def main():
    ...
    kkt.blit(scr)#    scrn_sfc.blit(bomb_sfc, bomb_rct) 
    ...
    # 練習２
    while True:
        Screen.blit()# scrn_sfc.blit(pgbg_sfc, pgbg_rct) 
